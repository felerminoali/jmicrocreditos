    ...
    <head>
        ...
        <script>
            function validarCadastro(){
                ...
                // if (document.formulario.password.value !== document.formulario.password1.value) {
                //     // alert("Senhas diferentes, Tente novamente");
                //
                //     document.formulario.password1.addClass("validate-input");
                //
                //     document.formulario.password.focus();
                //
                //     document.formulario.validate(document.formulario.password1);
                //
                //     return false;
                // }
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form"
                        ...
                        <div class="wrap-input100 validate-input m-b-18" data-validate="O Campo Sexo e Obrigatório!">
							...
							<select class="input100 select_box" name="sexo" id="sexo">
                        ...
                        <div class="wrap-input100 validate-input m-b-26" data-validate="O Campo Linha enderenço 1 e Obrigatório, Insira!">
                        ...
                        <div class="wrap-input100 validate-input m-b-26" data-validate="O Campo Contacto e Obrigatório, Insira!">
                            ...
                            <input class="input100" type="number" value="" id="contacto1" name="contacto1" placeholder="Insira o Contacto " autocomplete="off">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100 m-b-26">
                            ...
                            <input class="input100" type="number" value="" id="contacto2" name="contacto2" placeholder="Insira o Contacto " autocomplete="off">
                            <span class="focus-input100"></span>
                        ...
                        <div class="wrap-input100 validate-input m-b-26" data-validate="O Campo Email e Obrigatório, Insira!">
                            ...
                            <input class="input100" type="email" value="" id="email" name="email" placeholder="Insira o Email " autocomplete="off">
                            <span class="focus-input100"></span>

                        </div>

                        <div class="wrap-input100 validate-input m-b-26" data-validate="O Campo Senha e Obrigatório, Insira!">

                            <span class="label-input100">
                                <label for="Password">Senha </label>
                            </span>
                            <input class="input100" type="password" value="" id="password" name="password" placeholder="Insira a senha " autocomplete="off">
                            <span class="focus-input100"></span>

                        </div>

                        <div class="wrap-input100  m-b-26" data-validate="O Senha e Obrigatório, Insira!">

                            <span class="label-input100">
                                <label for="Password1">Confirmação de senha: </label>
                            </span>
                            <input class="input100" type="password" value="" id="password1" name="password1" placeholder="Insira a senha " autocomplete="off">
                            <span class="focus-input100"></span>
