<%-- 
    Document   : header
    Created on : Dec 16, 2018, 11:33:12 PM
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="has-sub">
                                <a href="#">
                                    ...
                                    <span class="bot-line"></span>Creditos</a>
                            ...
                            <li>
                                ...
                                <a href="Amortizacao.jsp?acao=2">
                                    <i class="fas fa-object-group"></i>
                                    <span class="bot-line"></span>Amortizacoes
                                </a>
                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                       ...
                       <li class="has-sub">
                                <a href="#">
                                    <i class="fas fa-credit-card"></i>
                                    <span class="bot-line"></span>Linhas de Creditos</a>
                            ...
                            <li>
                                ...
                                <a href="Amortizacao.jsp">
                                    <i class="fas fa-object-group"></i>
                                    <span class="bot-line"></span>Amostizacoes
                                </a>
                            </li>
                            
                            
                             <li class="has-sub">
                                 <a href="ListCliente.jsp">
                                    <i class="fas fa-users"></i>Clientes
                                    <span class="bot-line"></span>
                                </a>
